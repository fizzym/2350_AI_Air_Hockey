import gym
from air_hockey_gym.envs import SingleMalletShootDiscreteEnvV1
...
env = SingleMalletShootDiscreteEnvV1(puck_box=[(-0.6, 0.25), (-0.2, -0.25)], mal1_box=[(-0.9, 0.3), (-0.7, -0.3)], mal2_box=[(0.7, 0.3), (0.9, -0.3)])
...
model.learn(total_timesteps=100, tb_log_name="", callback=callback)

model.save("trained_models/ppo_model")
